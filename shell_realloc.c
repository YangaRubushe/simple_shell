...
/**
 * *shell_memory_set - fills memory with a constant byte
 * @s: pointer to the memory area
 * @b: byte to fill *s with
 * @n: the amount of bytes to be filled
 * Return: (s) a pointer to thr memory area s
 */
...
/**
 * shell_free - frees a string a strings
...
/**
 * shell_reallocate - reallocates a block of memory
